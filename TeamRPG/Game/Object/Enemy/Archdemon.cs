...
""";
        ...
        string gNum = "";
        string name;
        public Archdemon(int _x, int _y, string _num) // default는 중앙으로잡고 거기서 위치를잡게끔
        {
            gNum = _num;
            name = "아크데몬" + gNum;
            x = _x;
        ...
        {
            nameText = new RawText("아크데몬" + gNum, x, y - 2, HorizontalAlign.Center);
            imageText = new RawText(normalImage, x-10, y, HorizontalAlign.Center);
