...
""";
        ...
        string gNum = "";
        string name;
        public Imp(int _x, int _y, string _num) // default는 중앙으로잡고 거기서 위치를잡게끔
        {
            gNum = _num;
            name = "임프" + gNum;
            x = _x;
        ...
        {
            nameText = new RawText("임프" + gNum, x, y - 2, HorizontalAlign.Center);
            imageText = new RawText(normalImage, x-22, y, HorizontalAlign.Center);
